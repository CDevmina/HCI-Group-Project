...
const LoginPage = () => {
  ...
  const handleChange = (e) => {
    ...
    // Clear general login error when form is modified
    if (loginError) {
      setLoginError("");
    }
  };
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:block md:w-1/2 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1586023492125-27b2c045efd7?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZnVybml0dXJlfGVufDB8fDB8fHww')",
          ...
          <div className="relative">
            ...
            <div className="mt-16">
              <h2 className="text-4xl font-bold leading-tight text-white drop-shadow-lg">
                Transform spaces with intelligent design
              </h2>
              <div className="mt-4 bg-black/20 backdrop-blur-sm p-3 rounded-lg inline-block">
                <p className="text-white text-lg drop-shadow-md">
                  Create stunning room layouts and visualize furniture in both
                  2D and 3D with our powerful design tools.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  type="button"
                  className="text-sm font-medium text-blue-600 hover:text-blue-500 focus:outline-none focus:underline transition duration-150 ease-in-out"
                  onClick={() =>
                    alert(
